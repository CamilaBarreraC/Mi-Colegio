                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="accordion-item">
                                            <div id="flush-collapseBrands" class="accordion-collapse collapse show" aria-labelledby="flush-headingBrands">
                                                <div class="accordion-body text-body pt-0">
                                                    <h5 class="fs-16" style="margin-top: 15px">Regiones</h5>
                                    ...
                                    <!--Excel-->
                                    <form action="reporteExcel.php" class="btn btn-primary" style="background-color:green;" method="post">
                                        <button type="submit" name="reporte_colegio" class="btn btn-primary" style="background-color:green; border: none">
                                            <img style="width:20px; height:auto;" src="image/icono-excel.png" alt="Excel Icon" class="icon">
                                        </button>
                                    </form>

                                    <!--PDF-->
                                    <form action="reportePDF.php" class="btn btn-primary" style="background-color:red" method="post">
                                        <button type="submit" name="reporte_colegio" class="btn btn-primary" style="background-color:red; border: none">
