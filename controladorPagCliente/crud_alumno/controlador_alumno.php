...
class ControladorAlumno {
    ...
    public function actualizarAlumno($nombre_alumno, $apellido_paterno, $id_curso, $rut_apoderado, $id_alumno){
        return ($this->modelo->actualizarAlumno($nombre_alumno, $apellido_paterno, $id_curso, $rut_apoderado, $id_alumno) != false) ? header("Location: alertasPagCliente/AlertasAlumno/alertaActualizar.php?id_alumno=".$id_alumno) : header("Location: alertasPagCliente/AlertasAlumno/alertaActualizar.php");
    }
    ...
    public function showAlumno2($id_alumno){
        ...
        return $modelo->showAlumno2($id_alumno);
    }

    public function eliminarAlumno($id_alumno){
        return ($this->modelo->eliminarAlumno($id_alumno)) ? header("Location: alertasPagCliente/AlertasAlumno/alertasEliminar.php") : header("Location: alertasPagCliente/AlertasAlumno/alertasEliminar.php?id_alumno=".$id_alumno);
    }
}
?>