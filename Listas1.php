                                ...
                                <div class="card-body">
                                    <button type='button' class='btn btn-info add-btn' data-bs-toggle='modal'
                                        ...
                                        style="background-color:blueviolet;margin-bottom: 20px"><i
                                            class="ri-add-line align-bottom me-1"></i>Añadir lista</button>
                                            ...
                                            <div id="flush-collapseBrands" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body text-body pt-0">
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="Listas1.php" class="link-secondary ms-3">Limpiar
                                                            filtros</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='d-flex gap-2'>
                                                        <div class='edit'>
                                                            <a
                                                                href="productoLista1.php?id_lista_1=<?= $row['id_lista_1'] ?>">
                                                                <button type='button'
                                                                    class='btn btn-sm btn-info edit-item-btn'
                                                                    style="background-color:teal;">Ver
                                                                    productos</button>
                                                            </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class='d-flex gap-2'>
                                                        <div class='edit'>
                                                            <a
                                                                href="editLista1.php?id_lista_1=<?= $row['id_lista_1'] ?>">
                                                                <button type='button'
                                                        ...
                                                        <div class='remove'>
                                                            <button class='btn btn-sm btn-primary remove-item-btn'
                                                                ...
                                                                data-id_producto="<?= $row['id_lista_1'] ?>">Eliminar</button>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="row g-3">
                            <div class="col-xxl-6" style="display: none;">
                                <div style="display: none;">
                                    <label for="id_lista_1" class="form-label" style="margin-top: 0px; display:none">ID
                                        Lista</label>
                                    <input type="text" class="form-control" id="id_lista_1" name="id_lista_1" value=""
                                        placeholder="ID lista 1" style="display: none;">
                                </div>
                            </div>
                            <!--end col-->
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    ...
                                    <label for="id_curso" class="form-label" style="margin-top: 0px;">Nombre
                                        curso</label>
                                    <select class="form-control" name="id_curso" id="id_curso" required
                                        onchange="updateCursoName()">
