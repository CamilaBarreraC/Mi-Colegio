...
<?php
    ...
    JOIN lista_2 ON lista_2.rut_cliente = detalle_pedido.rut_cliente_l2
    ...
    JOIN productos_extra ON productos_extra.rut_cliente = detalle_pedido.rut_cliente_extras
